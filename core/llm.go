...
func (llm *LLM) WithLazyTools(id *call.ID, objType dagql.ObjectType, except []string, replanOnLoad bool) *LLM {
	llm = llm.Clone()
	llm.mcp = llm.mcp.WithLazyTools(id, objType, except, replanOnLoad)
	return llm
}
