...
func (s *secretSchema) secret(ctx *router.Context, parent struct{}, args secretArgs) (string, error) {
...
func (s *secretSchema) addSecret(ctx *router.Context, parent struct{}, args addSecretArgs) (any, error) {
