...
Every commit is signed off and carries no attribution trailer. No commit has been amended since the binding start; the two evidence commits predate it and are byte-identical to the originals.
