...
export class Container extends BaseClient {
   ...
   * @param fileName The name of the tarball file (e.g. "container.tar")
   ...
   * for older runtimes without OCI support.
   */
  asTarball(fileName: string, opts?: ContainerAsTarballOpts): File {
    ...
    return new File({
      queryTree: [
        ...
        {
          operation: "asTarball",
          args: { fileName, ...opts, __metadata: metadata },
        },
      ],
