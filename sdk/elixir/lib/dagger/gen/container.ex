...
defmodule Dagger.Container do
  ...
  (
    ...
    @spec as_tarball(t(), Dagger.String.t(), keyword()) :: Dagger.File.t()
    def as_tarball(%__MODULE__{} = container, file_name, optional_args \\ []) do
      selection = select(container.selection, "asTarball")
      selection = arg(selection, "fileName", file_name)
