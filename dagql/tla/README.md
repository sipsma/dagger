...
fail or deliberately accepted model findings.
...
`decode_cancel` reproduces a decode leader's own cancellation failing
its joiners (see the config header). Every other configuration is a
