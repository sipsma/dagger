...
// objects when the loading server only has the bootstrap schema. Resolving the
// type must load the recorded module provenance without evaluating the object.
